...
const ACCENT = "#D6A24A";
const CTA_DARK = "#08111F";

// Palette inspired by Warsh-recitation regions in North & West Africa:
// deep Maghrebi emerald, Moroccan/Tunisian burgundy, Mauritanian/Sahel gold, and night indigo.
const WARSH_LUXURY_GRADIENT =
  "bg-[linear-gradient(135deg,#03100E_0%,#064236_32%,#4E1726_66%,#C89237_100%)]";
const OUTER_GRADIENT = WARSH_LUXURY_GRADIENT;
const INNER_GRADIENT = WARSH_LUXURY_GRADIENT;
const BACKGROUND_GRADIENT =
  "bg-[radial-gradient(circle_at_16%_8%,rgba(200,146,55,0.16),transparent_26%),radial-gradient(circle_at_84%_18%,rgba(6,66,54,0.22),transparent_30%),radial-gradient(circle_at_45%_90%,rgba(78,23,38,0.18),transparent_34%),linear-gradient(180deg,#020507_0%,#07111F_45%,#030D0B_100%)]";
const LINE_GRADIENT = WARSH_LUXURY_GRADIENT;
const TEXT_GRADIENT =
  "bg-[linear-gradient(90deg,#F6E3A0_0%,#D6A24A_45%,#8FE6D2_100%)]";
...
function HeroAudioPlayer({ isMobile }) {
  ...
  return (
    <div className="mt-5 rounded-[1.35rem] border border-white/10 bg-[#08111F]/55 p-3 sm:p-4">
      <audio
        ref={audioRef}
        preload="metadata"
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/5 p-4">
        <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-gradient-to-l from-white/5 to-white/10 px-4 py-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-[#D6A24A]/10">
        ...
        <div className="mt-4 rounded-2xl border border-white/10 bg-[#08111F]/55 px-4 py-4 text-sm leading-7 text-white/78 sm:text-base sm:leading-8">
          {desc}
        </div>
      </div>
    </motion.div>
  ...
  return (
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/5 p-4">
        ...
        <div
          className={`mt-4 rounded-2xl border border-white/10 bg-[#08111F]/55 px-4 py-4 text-white/80 ${
            large
    ...
    >
      <div className="relative overflow-hidden rounded-[1.4rem] border border-white/10 bg-black/30">
        ...
        {!isPlaying && (
          ...
          >
            <span className="flex h-16 w-16 items-center justify-center rounded-full border border-white/20 bg-white/10 backdrop-blur-md shadow-[0_0_22px_rgba(214,162,74,0.16)] sm:h-18 sm:w-18">
      ...
      <div className="mt-4 rounded-[1.3rem] border border-white/10 bg-[#08111F]/55 p-3 sm:p-4">
        <div className="flex flex-wrap items-center gap-2">
          <button
            type="button"
            onClick={toggleMute}
    ...
    <LazyMotion features={domAnimation}>
      ...
      >
        ...
        {!isMobile && (
          <>
            <motion.div
              className="absolute -top-24 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-[rgba(214,162,74,0.16)] blur-3xl"
              animate={pulseGlow}
            />
        ...
        <div className={containerClass}>
          <header className="pt-4 sm:pt-6">
            <motion.div
              ...
              animate="show"
              variants={fadeUp}
              className={`mx-auto flex items-center justify-between gap-3 rounded-[1.5rem] px-3 py-3 sm:rounded-[2rem] sm:px-4 ${frameShell}`}
            >
              <div className="flex min-w-0 items-center gap-3 sm:gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-full border border-[#D6A24A]/25 bg-white/10 shadow-[0_0_16px_rgba(214,162,74,0.16)] sm:h-16 sm:w-16">
                  <img
                    src={sanaLogo}
              ...
              <nav className="hidden items-center gap-3 md:flex">
                {navItems.map((item) => (
                  <a
                    key={item.href}
                    href={item.href}
                    className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-white/85 transition hover:border-[#D6A24A]/35 hover:bg-white/10 hover:text-[#F5E1A3]"
                  >
                    {item.label}
                  </a>
                ))}
          ...
          <section className="relative grid min-h-[auto] items-center gap-10 py-10 sm:gap-12 sm:py-14 lg:min-h-[84vh] lg:grid-cols-[1.05fr_0.95fr] lg:py-20">
            <div className="order-1 lg:order-1">
              <motion.div
                ...
                animate="show"
                variants={fadeUp}
                className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#D6A24A]/25 bg-white/10 px-4 py-2 text-xs backdrop-blur-md sm:text-sm"
                style={{ color: ACCENT }}
              >
              ...
              >
                ...
                <a
                  href="https://www.youtube.com/@SANA-Ar-Warsh"
                  target="_blank"
                  rel="noreferrer"
            ...
            >
              ...
              >
                <div className="rounded-[1.6rem] border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-4 sm:p-6">
                  ...
                  <div className="mt-6 rounded-[1.4rem] border border-white/10 bg-[#08111F]/70 p-4 sm:mt-8 sm:p-6">
                    <div className="mb-4 flex items-start gap-3 text-sm text-white/80 sm:items-center sm:text-base">
                      <Headphones className="mt-0.5 h-5 w-5 shrink-0 text-[#F5E1A3] sm:mt-0" />
          ...
          <section className="py-8 lg:py-12">
            ...
            >
              {!isMobile && (
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_25%_25%,rgba(214,162,74,0.12),transparent_30%),radial-gradient(circle_at_80%_78%,rgba(6,66,54,0.18),transparent_34%)]" />
              )}

              <div className="relative z-10">
                <div className="grid gap-6 lg:grid-cols-2 lg:items-stretch lg:gap-8">
                  <div className="rounded-[1.8rem] border border-white/10 bg-[#08111F]/45 p-4 sm:p-6">
                  ...
                  <div className="rounded-[1.8rem] border border-white/10 bg-[#08111F]/70 p-4 sm:p-6">
                    <div className="flex h-full flex-col justify-center rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="mt-5 inline-flex w-fit items-center gap-2 rounded-2xl border border-[#D6A24A]/25 bg-[#D6A24A]/10 px-5 py-3 text-sm text-[#F5E1A3] transition hover:bg-[#D6A24A]/20 sm:text-base"
                      >
          ...
          <section id="contact" className="py-8 lg:py-12">
            ...
            >
              ...
              >
                <div className="rounded-[2rem] border border-white/10 bg-[#08111F]/70 p-4 sm:p-6">
                  <div className="rounded-[1.5rem] border border-white/10 bg-white/5 p-4 sm:p-5">
                    ...
                    <div className="space-y-3 text-white/75">
                      ...
                      <a
                        ...
                        className="flex items-center justify-center gap-3 rounded-2xl border border-[#D6A24A]/25 bg-[#D6A24A]/10 px-4 py-3 text-center text-sm font-semibold text-[#F5E1A3] transition hover:bg-[#D6A24A]/20 sm:text-base"
                      >
            ...
            <div className={`rounded-[2rem] px-4 py-6 sm:px-6 sm:py-8 lg:px-10 ${glass}`}>
              <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr_1fr]">
                ...
                >
                  ...
                  <p className="mx-auto mt-4 max-w-[30rem] rounded-[1.4rem] border border-white/10 bg-[rgba(8,17,31,0.58)] px-4 py-4 text-sm leading-7 text-white/78 sm:px-5 sm:text-base sm:leading-8">
                ...
                <div className={`rounded-[1.8rem] border border-white/10 ${INNER_GRADIENT} p-4 backdrop-blur-md sm:p-5 flex flex-col items-center justify-center text-center`}>
                  ...
                  <div className="w-full space-y-4 text-white/72">
                    <a
                      href="mailto:snachannel159@gmail.com"
                      className="flex items-center justify-center gap-3 break-all rounded-2xl border border-white/10 bg-[#08111F]/50 px-4 py-3 text-sm transition hover:bg-white/10 sm:text-base"
                    >
                      <Mail className="h-4 w-4 shrink-0" style={{ color: ACCENT }} />
                      snachannel159@gmail.com
                    </a>

                    <div className="flex items-center justify-center gap-3 rounded-2xl border border-white/10 bg-[#08111F]/50 px-4 py-3 text-sm sm:text-base">
                      <MapPin className="h-4 w-4 shrink-0" style={{ color: ACCENT }} />
                      عمّان - الأردن
                    </div>
                  </div>

                  <div className="mt-6 w-full rounded-[1.4rem] border border-white/10 bg-[#08111F]/45 p-4">
                    <a
                      href="https://www.facebook.com/share/14iHA8X6ieN/"
                      target="_blank"
                      rel="noreferrer"
                ...
                <div className={`rounded-[1.8rem] border border-white/10 ${INNER_GRADIENT} p-4 backdrop-blur-md sm:p-5 flex flex-col items-center justify-center text-center`}>
                  ...
                  <div className="w-full rounded-[1.4rem] border border-white/10 bg-[#08111F]/45 p-4">
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                      ...
                      >
                        <div className="flex items-center justify-center gap-3">
                          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-[#D6A24A]/10 text-white">
                            <GooglePlayIcon />
                          </div>
                    ...
                    <div className="mt-5 rounded-[1.4rem] border border-white/10 bg-[#08111F]/60 p-4">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl border border-[#D6A24A]/25 bg-[#D6A24A]/10 py-3 text-sm font-bold text-[#F5E1A3] transition hover:scale-[1.01] hover:bg-[#D6A24A]/20"
                      >
